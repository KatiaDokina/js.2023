...
userForm.addEventListener('submit', function (e) {
    ...
    userData.innerText = `name: ${this.name.value}, surname: ${this.surname.value}, age: ${this.age.value}`;
    this.name.value = '';
    this.surname.value = '';
    this.age.value = '';
    document.getElementById('userData').append(userData)
...
for (const session of sessions) {
    ...
    div.innerText = ` ${new Date(session)}`
    document.getElementById('sessions').append(div)
}
// =========================
...
let getElements = function (first, last) {
    let arr = [];
    let wrapper = document.getElementById('wrapper')
    for (let i = firstIndex; i < lastIndex; i++) {
        const prevButtonElement = prevButton[i];
        let main = document.createElement('main');
        main.classList.add('main')
        let div = document.createElement('div');
        div.innerText = `id: ${array[i].id}`;
        div.classList.add('id')
        let div1 = document.createElement('div1');
        div1.innerText = `title: ${array[i].title}`;
...
getElements(firstIndex, lastIndex);
...
userAge.addEventListener('submit', function () {
...
tableForm.addEventListener('submit', function (e) {
    ...
    table.replaceChildren(...rowsArray);
})
