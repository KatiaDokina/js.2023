...
for (const ArrayElement of coursesAndDurationArray) {
    ...
    h3.innerText = `title - ${ArrayElement.title}, monthDuration - ${ArrayElement.monthDuration}`
    div.append(h3)
    document.body.appendChild(div)
}
// =========================
...
// Завдання робити через цикли.
for (const Array1Element of coursesAndDurationArray1) {
    let div = document.createElement('div');
    ...
    h1.innerText = `title - ${Array1Element.title}`;
    p.innerText = `monthDuration - ${Array1Element.monthDuration}`
...
for (const simpson of simpsons) {
    ...
    h2.innerText = `name - ${simpson.name}, surname - ${simpson.surname}, age - ${simpson.age}`;
    let p = document.createElement('p');
...
for (const coursesArrayElement of CoursesArray) {
    ...
    div2.classList.add('hourDuration');
